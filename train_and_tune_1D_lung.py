...
class DANNwithTrainingTuning_1D(DANN_1D):
    ...
    def data_loader(self, data_dir, input_size, feature_type, R01BTuning):
        ...
        self.data_idonly=data[["SampleID","Train_Group","train","Project","Domain"]]
    ...
    def cluster_cancerdata(self, methods = "kmeans", encoding_size = 256, n_cluster = 3):
    ...
    def fit(self, output_path, R01BTuning_fit):
        ...
        with torch.no_grad():
            ...
            print("================== DANN score ======================")
            print(f"Training AUC: {self.training_auc:.4f}, threshold 98: {threshold98:.4f}, R01B sensitivity: {self.testing_sens:.4f}")
            print("====================================================")
        ...
        if(self.R01BTuning and R01BTuning_fit):
            ...
            self.data_idonly.to_csv(f"{output_path}/R01BTuned/{self.feature_type}_score_R01BTuned_{self.methods}_cluster{self.selected_cluster}_lung.csv", index=False)
    ...
    def crossvalidation(self,num_folds, output_path):
        ...
        df.to_csv(f"{output_path}/cv/{self.feature_type}_CV_score_{self.methods}_cluster{self.selected_cluster}_lung.csv", index=False)
